...
<li class="nav-item <?php echo $this->uri->segment(1) == 'Transaksi' && $this->uri->segment(2) == 'requeststaff'? 'active' : ''?>">
  <a class="nav-link" href="<?php echo base_url()."index.php/Transaksi/request".$type?>">
    <i class="fas fa-fw fa-arrow-up"></i>
    <span>Request</span></a>
</li>

<li class="nav-item <?php echo $this->uri->segment(1) == 'Transaksi' && ($this->uri->segment(2) == '' || ($this->uri->segment(2) == 'staff' && $this->uri->segment(3) == '') || $this->uri->segment(2) == 'get') ? 'active' : ''?>">
